import Button from "@/components/lincolnguessr/Button";
import ConfirmationPopup from "@/components/lincolnguessr/ConfirmationPopup";
import LincolnGuessrHelp from "@/components/lincolnguessr/LincolnGuessrHelp";
import {
	faClose,
	faMap,
	faMinus,
...
import Timer from "@/components/lincolnguessr/Timer";
import Image from "next/image";
import Leaderboard from "@/components/lincolnguessr/Leaderboard";
import toast from "react-hot-toast";

import dynamic from "next/dynamic";

const LincolnGuessrMap = dynamic(
	() => import("@/components/lincolnguessr/LincolnGuessrMap"),
	{
...
export default function LincolnGuessr() {
	...
	function handleStartGame() {
		...
		console.log(getRandomEntries(allLocations, 3));
